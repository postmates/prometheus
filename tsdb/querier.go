...
func NewBlockQuerier(b BlockReader, mint, maxt int64) (storage.Querier, error) {
	// Since everything inside block reader is given in chunks, just use ChunkQuerier and convert to Querier.
	// TODO(bwplotka) This is nice, but it's not efficient. We decode stuff for no reason ):
